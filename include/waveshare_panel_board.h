// Google Drive build: 2026-07-20 Waveshare timing + stabilized RGB DMA
// Project-owned ESP32_Display_Panel configuration for the exact
// Waveshare ESP32-S3-Touch-LCD-7 (ST7262 + GT911) board.
#pragma once
...
// Twenty scanlines follows Espressif's heavier-load recommendation for
// ESP32-S3 RGB panels using WiFi and PSRAM. 800*480 / (800*20) = 24, an even
// multiplier as required by the RGB driver.
...
// Backlight and reset are controlled explicitly through the CH422G by the
// Waveshare wrapper, so ESP32_Display_Panel must not create either device.
