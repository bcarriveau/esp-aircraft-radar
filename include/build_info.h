...
constexpr uint32_t FIRMWARE_VERSION_CODE = 84;
constexpr const char* FIRMWARE_VERSION_LABEL = "Product 84";
...
constexpr const char* FIRMWARE_RELEASE_NOTES =
    "Enlarges the selected and tracked aircraft type icon using the existing high-resolution aircraft sprites while keeping normal side icons unchanged.";
