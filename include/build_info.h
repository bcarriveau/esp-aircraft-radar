...
constexpr uint32_t FIRMWARE_VERSION_CODE = 92;
constexpr const char* FIRMWARE_VERSION_LABEL = "Product 92";
...
constexpr const char* FIRMWARE_RELEASE_NOTES =
    "Prefills airport builder from saved radar coordinates and removes location-specific examples.";
