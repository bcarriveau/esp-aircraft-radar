...
constexpr uint32_t FIRMWARE_VERSION_CODE = 93;
constexpr const char* FIRMWARE_VERSION_LABEL = "Product 93";
...
constexpr const char* FIRMWARE_RELEASE_NOTES =
    "Shows update release notes clearly and restores the last selected radar range after restart.";
