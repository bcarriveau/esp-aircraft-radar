...
constexpr uint32_t FIRMWARE_VERSION_CODE = 90;
constexpr const char* FIRMWARE_VERSION_LABEL = "Product 90";
...
constexpr const char* FIRMWARE_RELEASE_NOTES =
    "Hardens airport upload handoff timing and safe retry behavior.";

constexpr const char* BUILD_ID =
    "7IN-20260813-PRODUCT90-AIRPORT-UPLOAD-HANDOFF";
