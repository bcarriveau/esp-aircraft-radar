...
def test_product_81_marker_is_present():
    assert "FIRMWARE_VERSION_CODE = 81" in BUILD_INFO
    assert 'FIRMWARE_VERSION_LABEL = "Product 81"' in BUILD_INFO
    assert '7IN-20260807-PRODUCT81-80MI-HEADING' in BUILD_INFO
...
def test_40_and_80_mile_symbols_use_target_heading():
    assert "const uint8_t renderedHeadingIndex = screen.headingIndex;" in RENDERER
